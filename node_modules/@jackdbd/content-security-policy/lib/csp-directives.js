...
import { cspSourceValuesStyleAttr, cspSourceValuesScriptElem, cspSourceValuesScriptAttr, cspSourceValuesStyleElem } from './source-values.js';
import { stringReplacer } from './utils.js';
const debug = defDebug(`${DEBUG_PREFIX}:csp-directives`);
/**
 * @public
 */
export const cspDirectives = async ({ directives, patterns }) => {
    const m = { ...directives };
    const [script_src, script_src_attr, script_src_elem, style_src, style_src_attr, style_src_elem] = await Promise.all([
...
//# sourceMappingURL=csp-directives.js.map